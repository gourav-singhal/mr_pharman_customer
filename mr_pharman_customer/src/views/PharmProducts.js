...
const PharmProducts = (props) => {
  ...
  const navigate_product_details = (data) =>{
    navigation.navigate('PharmProductDetails', {data:data, pharm_id:pharm_id})
  }
  ...
  const renderItem = ({ item }) => (
    <CardView
      ...
      cardMaxElevation={5}
      cornerRadius={10}>
      <TouchableOpacity activeOpacity={1} onPress={navigate_product_details.bind(this, item)} style={{ alignItems:'center', justifyContent:'center' }}>
